...
- Load in the `wellbeing.csv`, `participant_info.csv`, and `screen_time.csv` from your data folder
...
## Smartphone and well-being for boys and girls {#mulregression-a5}
...
> Provide a write-up of the regression model. Please make to include all relevant statsitics. 
